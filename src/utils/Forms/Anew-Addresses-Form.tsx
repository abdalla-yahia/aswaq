  ...
  return (
    ...
    <div className="flex flex-col justify-start items-start gap-2 w-full md:w-1/2">
        ...
        <div className="flex justify-between items-center w-full gap-2">
            <h2>اسم العنون : </h2>
            <div className="w-3/4">
            <InputButton type="text" placeholder="أضف اسم العنوان جديد" />
            </div>
        </div>
        {/*Address */}
        <div className="flex justify-between items-center w-full gap-2">
            <h2>العنون : </h2>
            <div className="w-3/4">
            <InputButton type="text" placeholder="أضف العنوان الجديد" />
            </div>
        </div>
        {/*Phone */}
        <div className="flex justify-between items-center w-full gap-2">
            <h2>رقم الهاتف : </h2>
            <div className="w-3/4">
            <InputButton type="text" placeholder="أضف رقم الهاتف للعنوان " />
            </div>
        </div>
        <SubmitButton text="حفظ" bgcolor="bg-accent" textcolor=""/>
    </div>
    </>
  )
}
