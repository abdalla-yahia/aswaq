import { CREATE_PRODUCT, DELETE_PRODUCT, GET_ALL_PRODUCTS, GET_PRODUCT_BY_ID, GET_PRODUCT_BY_SLUG, GET_PRODUCTS_BY_BRAND_ID, GET_PRODUCTS_BY_CATEGORY_ID } from "@/Graphql/Schemas/ProducrQuery";
...
// Get Product By ID
export const getProductById = createAsyncThunk('product/getById', async (productId: string) => {
    try {
        const {data} = await client.query({
...
// Get Product By Slug
export const getProductBySlug = createAsyncThunk('product/getBySlug', async (slug: string) => {
    try {
        const {data} = await client.query({
...
export const getProductsByCategory = createAsyncThunk('product/getByCategory', async (categoryId: string) => {
    try {
        const {data} = await client.query({
...
export const getProductsByBrand = createAsyncThunk('product/getByBrand', async (brandId: string) => {
    try {
        const {data} = await client.query({
