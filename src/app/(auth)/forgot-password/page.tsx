...
export default function ForgotPassword() {
  return (
    ...
    <ForgotPasswordForm />
    <Image src={'https://static.vecteezy.com/system/resources/previews/059/979/573/non_2x/acclaimed-avant-garde-confused-man-scratching-head-no-background-with-transparent-background-original-free-png.png'} alt="forgot-pass" width={100} height={100} />  
